...
function createSlide(pres, customTheme) {
  ...
  // Title
  slide.addText("Pencatatan Transaksi", {
  ...
  const bullets = [
    { text: "Jenis: Pemasukan & Pengeluaran", options: { bullet: true, breakLine: true } },
    { text: "Kategori dengan icon kustom", options: { bullet: true, breakLine: true } },
    { text: "Lampiran: foto & file arbitrary", options: { bullet: true, breakLine: true } },
    { text: "Recurring: Daily, Weekly, Monthly", options: { bullet: true, breakLine: true } },
    { text: "Soft delete dengan restore", options: { bullet: true } }
  ];
  ...
  const rowH = 0.65;
  const items = [
    { icon: "+", label: "Gaji", amount: "+ 8.500.000", color: t.accent },
    { icon: "-", label: "Belanja", amount: "- 250.000", color: "E57373" },
...
if (require.main === module) {
  ...
  pres.writeFile({ fileName: "C:/Users/muham/catatan_keuangan/slides/slide-05-preview.pptx" })
