/**
 * Slide 03: Feature Overview - Gambaran Umum Aplikasi
...
function createSlide(pres, theme) {
  ...
  // --- Page title ---
  slide.addText("Gambaran Umum Aplikasi", {
  ...
  const features = [
    {
      icon: "T",
      label: "Transaksi",
      desc: "Pencatatan transaksi harian"
    },
    {
      icon: "D",
      label: "Dompet",
      desc: "Multi-wallet dengan saldo"
    },
    {
      icon: "B",
      label: "Budget",
      desc: "Budget bulanan per kategori"
    },
    {
      icon: "P",
      label: "PDF",
    ...
    },
    {
      icon: "BK",
      label: "Backup",
      desc: "Backup terenkripsi AES-256"
    },
    {
      icon: "K",
      label: "Keamanan",
