/**
 * Slide 07: Budget & Statistik (Content Page)
...
function createSlide(pres, customTheme) {
  ...
  // --- Slide title ---
  slide.addText("Budget & Statistik", {
  ...
  // Left bullet points
  slide.addText([
    { text: "Set budget per kategori per bulan", options: { bullet: true, breakLine: true } },
    { text: "Progress bar hijau \u2192 merah", options: { bullet: true, breakLine: true } },
    { text: "Perbandingan dengan aktual", options: { bullet: true } }
  ], {
  ...
  // Right bullet points
  slide.addText([
    { text: "Ringkasan per kategori", options: { bullet: true, breakLine: true } },
    { text: "Progress indicator visual", options: { bullet: true, breakLine: true } },
    { text: "Navigasi bulan/tahun", options: { bullet: true } }
  ], {
  ...
  // Section label
  slide.addText("Progress Pengeluaran", {
  ...
  // Makanan 80% (green)
  addProgressBar("Makanan", 80, t.primary, barY);
  // Transportasi 45% (green)
  addProgressBar("Transportasi", 45, t.secondary, barY + 0.5);
  // Hiburan 100% (red - over budget)
  addProgressBar("Hiburan", 100, "E53935", barY + 1.0);
