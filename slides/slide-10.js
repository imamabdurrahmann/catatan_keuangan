/**
 * Slide 10: Backup & Enkripsi (Content Page)
...
function createSlide(pres, customTheme) {
  ...
  const leftItems = [
    "Daftar file backup dengan metadata",
    "Enkripsi AES-256-CBC",
    "Swipe-to-delete",
    "Share via sistem",
    "Restore dari daftar atau file picker"
  ];
  ...
  const rightItems = [
    ...
    "Auto-lock saat background",
    "PIN wajib jika biometric aktif"
  ];
