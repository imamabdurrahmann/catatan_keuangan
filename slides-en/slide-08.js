/**
 * Slide 08: PDF Reports (Content Page)
...
function createSlide(pres, customTheme) {
  ...
  // Bullet points
  slide.addText([
    { text: "Generate monthly report", options: { bullet: true, breakLine: true } },
    { text: "Attachment thumbnails in PDF", options: { bullet: true, breakLine: true } },
    { text: "Share via printing package", options: { bullet: true, breakLine: true } },
    { text: "Max 4 images per transaction", options: { bullet: true } }
  ], {
  ...
  slide.addText("Financial Records", {
  ...
  slide.addText("Financial_Records_April_2026.pdf", {
  ...
  // --- Table data rows ---
  const rows = [
    ["Food", "Rp 2,000,000", "Rp 1,600,000"],
    ["Transport", "Rp 500,000", "Rp 225,000"],
    ["Entertainment", "Rp 300,000", "Rp 300,000"]
  ];
  ...
  slide.addText("Image Attachments", {
