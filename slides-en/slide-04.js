// slide-04.js - Section Divider: Core Features
...
function createSlide(pres, customTheme) {
  ...
  // Section title "Core Features" - bold white on the green bar
  ...
  slide.addText("Core application capabilities", {
...
if (require.main === module) {
  ...
  pres.writeFile({ fileName: "C:/Users/muham/catatan_keuangan/slides-en/slide-04-preview.pptx" })
