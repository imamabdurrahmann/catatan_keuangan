...
table(
    ...
    [
        ...
        ['Enkripsi', 'encrypt + pointycastle', '5.0.3 / 3.9.1', 'AES-256-CBC encryption'],
...
└── pages/
    ...
    ├── statistik_page.dart      Statistik spending
...
table(
    ...
    [
        ...
        ['Android', 'CAMERA', 'Capture lampiran foto'],
...
table(
    ...
    [
        ...
        ['universal', 'app-universal-release.apk', '~65.3 MB', 'Semua arsitektur'],
    ],
...
body('Flag --no-tree-shake-icons mencegah app.so corruption saat build parallel.')

# ── SAVE ──────────────────────────────────────────────────
out = 'C:/Users/muham/catatan_keuangan/Dokumentasi_Catatan_Keuangan.docx'
doc.save(out)
